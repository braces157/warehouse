...
public class EditSupplierDialog extends javax.swing.JDialog {
    ...
    public EditSupplierDialog(java.awt.Frame parent, boolean modal, SupplierPage page, NhaCungCap ncc) {
        super(parent, modal);
        this.page = page;
        this.ncc = ncc;
        initComponents();
    ...
    public NhaCungCap getForm() {
        ...
        nhaCungCap.setMaNhaCungCap(this.ncc.getMaNhaCungCap());
        nhaCungCap.setTenNhaCungCap(txtTen.getText());
        nhaCungCap.setDiaChi(txtDiaChi.getText());
        nhaCungCap.setEmail(txtEmail.getText());
        nhaCungCap.setSoDienThoai(txtSdt.getText());
        return nhaCungCap;
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("SỬA THÔNG TIN NHÀ CUNG CẤP");
