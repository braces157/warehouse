...
public class ColorDialog extends javax.swing.JDialog {
    ...
    MauSacControllerImpl ct = new MauSacControllerImpl(new MauSacDAOImpl());
    List<MauSac> list = List.of();
    ...
    void loadTable() {
        ...
        model.setRowCount(0);
        for (MauSac ms : list) {
            Object[] row = {ms.getMaMau(), ms.getTenMau()};
            model.addRow(row);
        }
    }
    ...
    MauSac getForm() {
        ...
        if (table.getSelectedRow() != -1) {
            mau.setMaMau((int) table.getValueAt(table.getSelectedRow(), 0));
        }
        return mau;
    }
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        txtTenMau.setText(table.getValueAt(row, 1).toString());
