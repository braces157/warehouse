...
public class ROMDialog extends javax.swing.JDialog {
    ...
    DungLuongROMControllerImpl ct = new DungLuongROMControllerImpl(new DungLuongROMDAOImpl());
    List<DungLuongROM> list = List.of();
    ...
    void loadTable() {
        ...
        model.setRowCount(0);
        for (DungLuongROM dlROM : list) {
            Object[] row = {dlROM.getMaRom(), dlROM.getKichThuocRom()};
            model.addRow(row);
        }
    }
    ...
    DungLuongROM getForm() {
        DungLuongROM dl = new DungLuongROM();
        dl.setKichThuocRom(Integer.valueOf(txtDungLuong.getText()));
        if (table.getSelectedRow() != -1) {
            dl.setMaRom((int) table.getValueAt(table.getSelectedRow(), 0));
        }
        return dl;
    }
    ...
    private void initComponents() {
        ...
        lblTenDVT.setText("Dung lượng ROM(GB)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ROMDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ROMDialog dialog = new ROMDialog(new javax.swing.JFrame(), true);
