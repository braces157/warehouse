 ...
 * @author Braces
 */
public class DetailExportBill extends javax.swing.JDialog {
    ...
    CTPhieuXuatControllerImpl ctPX = new CTPhieuXuatControllerImpl(new CTPhieuXuatDAOImpl());

    public DetailExportBill(java.awt.Frame parent, boolean modal, PhieuXuat phieuXuat) {
        super(parent, modal);
    ...
    void init() {
        ...
        txtMaPhieu.setText(String.valueOf(phieuXuat.getMaPhieuXuat()));
        txtTenKH.setText(ctKH.getById(phieuXuat.getMaKH()).get().getTenKhachHang());
        txtTenNV.setText(ctTK.getById(phieuXuat.getNguoiTaoPhieuXuat()).get().getTenNv());
        txtTong.setText(Formatter.formatVND((double) phieuXuat.getTongTien()));
        lblDate.setText("Ngày tạo: " + Formatter.FormatDate(phieuXuat.getThoiGian()));
        loadTable();
    }

    void loadTable() {
        listCT = ctPX.getByPhieuXuat(phieuXuat.getMaPhieuXuat());
    ...
    private void initComponents() {
        ...
        jLabel8.setText("CHI TIẾT PHIẾU XUẤT");
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        fileChooser.setSelectedFile(new File("phieu_xuat_" + phieuXuat.getMaPhieuXuat() + ".pdf"));
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                PdfGenerator.generatePhieuXuat(
                        txtMaPhieu.getText(),
                        txtTenKH.getText(),
                        txtTenNV.getText(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailExportBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
