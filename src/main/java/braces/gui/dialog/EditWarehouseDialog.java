 ...
 * @author Braces
 */
public class EditWarehouseDialog extends javax.swing.JDialog {
    ...
    public EditWarehouseDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public EditWarehouseDialog(java.awt.Frame parent, boolean modal, WarehousePage page, KhuVucKho kvk) {
        super(parent, modal);
        this.page = page;
        this.kvk = kvk;
        initComponents();
    ...
    void init() {
        txtTen.setText(kvk.getTenKhuVuc());
        txtDiaChi.setText(kvk.getDiaChi());
    }

    KhuVucKho getForm() {
        KhuVucKho kvk = new KhuVucKho();
        kvk.setMaKhuVuc(this.kvk.getMaKhuVuc());
   ...
   public boolean validateForm() {
    ...
    private void initComponents() {
        ...
        lblDialog.setText("SỬA THÔNG TIN KHO HÀNG");
        ...
        btnSua.setFont(new java.awt.Font("Roboto Mono Medium", 0, 16)); // NOI18N
        ...
        btnSua.setPreferredSize(new java.awt.Dimension(200, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditWarehouseDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditWarehouseDialog dialog = new EditWarehouseDialog(new javax.swing.JFrame(), true);
