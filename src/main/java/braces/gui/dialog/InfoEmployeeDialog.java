 ...
 * @author Braces
 */
public class InfoEmployeeDialog extends javax.swing.JDialog {

    /**
     * Creates new form CreateEmployeeDialog
     */
    TaiKhoan tk;
    public InfoEmployeeDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public InfoEmployeeDialog(java.awt.Frame parent, boolean modal,TaiKhoan tk) {
        super(parent, modal);
        this.tk = tk;
        initComponents();
        init();
    ...
    void init(){
        ...
        cboRole.setSelectedIndex(tk.getRole()-1);
        cboStatus.setSelectedIndex(tk.getTrangThai());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoEmployeeDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InfoEmployeeDialog dialog = new InfoEmployeeDialog(new javax.swing.JFrame(), true);
