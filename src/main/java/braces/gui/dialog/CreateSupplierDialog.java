 ...
 * @author Braces
 */
public class CreateSupplierDialog extends javax.swing.JDialog {
    ...
    public CreateSupplierDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public CreateSupplierDialog(java.awt.Frame parent, boolean modal, SupplierPage page) {
        super(parent, modal);
        this.page = page;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateSupplierDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CreateSupplierDialog dialog = new CreateSupplierDialog(new javax.swing.JFrame(), true);
