...
import braces.gui.dialog.DetailImportBill;
...
public class ImportPage extends javax.swing.JPanel {
    ...
    PhieuNhapControllerImpl ct = new PhieuNhapControllerImpl(new PhieuNhapDAOImpl());
    List<PhieuNhap> list = List.of();
    ...
    public ImportPage(MainLayout main) {
        this.main = main;
        initComponents();
        init();
    }
    ...
    public void loadTable() {
        ...
        for (PhieuNhap pn : list) {
            model.addRow(new Object[]{
                pn.getMaPhieuNhap(),
                Formatter.FormatDate(pn.getThoiGian()),
                ctTK.getById(pn.getNguoiTaoPhieuNhap()).get().getTenNv(),
                ctNCC.getById(pn.getMaNhaCungCap()).get().getTenNhaCungCap(),
                Formatter.formatVND((double) pn.getTongTien())
            });
        }
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã", "Thời gian", "Tên nhân viên", "Tên nhà cung cấp", "Tổng tiền"
            }
        ) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        main.setPanel(new CreateImportBillPage(this));
    ...
    private void btnInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInfoActionPerformed
        ...
        Optional<PhieuNhap> pn = ct.getById(id);
        Dialog dialog = new DetailImportBill(null, true, pn.get());
