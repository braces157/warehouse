...
import braces.gui.dialog.CreateSupplierDialog;
import braces.gui.dialog.EditSupplierDialog;
import braces.gui.dialog.InfoSupplierDialog;
...
public class SupplierPage extends javax.swing.JPanel {
    ...
    List<NhaCungCap> list = List.of();
    NhaCungCapControllerImpl ct = new NhaCungCapControllerImpl(new NhaCungCapDAOImpl());
    ...
    public SupplierPage() {
        ...
        Optional<NhaCungCap> ncc = ct.getById(id);
        Dialog dialog = new EditSupplierDialog(null, true, this, ncc.get());
    ...
    void info(int row) {
        int id = (int) table.getValueAt(row, 0);
        Optional<NhaCungCap> ncc = ct.getById(id);
        Dialog dialog = new InfoSupplierDialog(null, true, ncc.get());
        dialog.setLocationRelativeTo(null);
        dialog.setResizable(false);
        dialog.setVisible(true);
    }
    ...
    public void init() {
        ...
        String[] searchType = {"Tất cả", "Mã", "Tên", "Email", "Sđt", "Địa chỉ"};
    ...
    public void loadTable() {
        ...
        for (NhaCungCap ncc : list) {
            Object[] row = {ncc.getMaNhaCungCap(), ncc.getTenNhaCungCap(), ncc.getDiaChi(), ncc.getEmail(), ncc.getSoDienThoai()};
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        lblTable.setText("THÔNG TIN NHÀ CUNG CẤP SẢN PHẨM");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        Dialog dialog = new CreateSupplierDialog(null, true, this);
        dialog.setLocationRelativeTo(null);
        dialog.setResizable(false);
        dialog.setVisible(true);
