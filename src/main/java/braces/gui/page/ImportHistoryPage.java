 ...
 * @author Braces
 */
public class ImportHistoryPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTable.setText("THÔNG TIN SẢN PHẨM ĐÃ NHẬP VÀO");
    ...
    private void jdcStartDatePropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jdcStartDatePropertyChange
        ...
        try {
            if (jdcStartDate.getDate() != null && jdcEndDate != null) {
                list = ct.getLichSuNhap(jdcStartDate.getDate(), jdcEndDate.getDate());
                loadTable();
            }
        } catch (Exception e) {
