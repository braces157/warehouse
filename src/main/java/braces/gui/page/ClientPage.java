...
import braces.gui.dialog.EditClientDialog;
import braces.gui.dialog.InfoClientDialog;
...
public class ClientPage extends javax.swing.JPanel {
    ...
    KhachHangControllerImpl ct = new KhachHangControllerImpl(new KhachHangDAOImpl());
    List<KhachHang> list = List.of();
    ...
    public void init() {
        ...
        String[] searchType = {"Tất cả", "Tên", "Sđt", "Địa chỉ"};
    ...
    void info(int row) {
        int id = (int) table.getValueAt(row, 0);
        Optional<KhachHang> kh = ct.getById(id);
        Dialog dialog = new InfoClientDialog(null, true, kh.get());
    ...
    void edit(int row) {
        int id = (int) table.getValueAt(row, 0);
        Optional<KhachHang> kh = ct.getById(id);
        Dialog dialog = new EditClientDialog(null, true, this, kh.get());
        dialog.setLocationRelativeTo(null);
        dialog.setResizable(false);
        dialog.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        cboSearchType.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                cboSearchTypePropertyChange(evt);
            }
        });
    ...
    private void cboSearchTypePropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_cboSearchTypePropertyChange
        // TODO add your handling code here:


    }//GEN-LAST:event_cboSearchTypePropertyChange
    ...
    private void loadTable() {
        ...
        for (KhachHang kh : list) {
            Object[] row = {kh.getMaKH(), kh.getTenKhachHang(), kh.getSoDienThoai(), kh.getDiaChi()};
            model.addRow(row);
        }
    }
