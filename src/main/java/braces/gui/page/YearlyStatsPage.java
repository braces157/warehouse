 ...
 * @author Braces
 */
public class YearlyStatsPage extends javax.swing.JPanel {
    ...
    void loadChart() {
        ...
        for (int i = 0; i < list.size(); i++) {
            sum_doanhthu = list.get(i).getTongTienXuat();
            sum_chiphi = list.get(i).getTongTienNhap();
            chart.addData(new ModelChart("Năm" + list.get(i).getThoiGian(), new double[]{sum_chiphi, sum_doanhthu}));
        }
    }
    ...
    private void btnStatisticActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStatisticActionPerformed
        try {
            int start = Integer.parseInt(txtFromYear.getText());
            int end = Integer.parseInt(txtToYear.getText());
            if (end < start) {
                MessageDialog.warring(this, "Năm bắt đầu phải bé hơn năm kết thúc");
                return;
            }
            list = tk.thongKeTheoNam(start, end);
            DefaultTableModel model = (DefaultTableModel) table.getModel();
            model.setRowCount(0);
            ...
            MessageDialog.warring(this, "Năm phải là sốsf");
        }
