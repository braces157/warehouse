...
import braces.gui.dialog.CreateWarehouseDialog;
import braces.gui.dialog.EditSupplierDialog;
import braces.gui.dialog.EditWarehouseDialog;
 ...
 */
@Getter
public class WarehousePage extends javax.swing.JPanel {

    KhuVucKhoControllerImpl ct = new KhuVucKhoControllerImpl(new KhuVucKhoDAOImpl());
    List<KhuVucKho> list = List.of();
    ...
    void edit(int row) {
        int id = (int) table.getValueAt(row, 0);
        Optional<KhuVucKho> kvk = ct.getById(id);
        Dialog dialog = new EditWarehouseDialog(null, true, this, kvk.get());
    ...
    public void init() {
        ...
        String[] searchType = {"Tất cả", "Mã", "Tên", "Địa chỉ"};
    ...
    void loadTable() {
        ...
        for (KhuVucKho kvk : list) {
            Object[] row = {kvk.getMaKhuVuc(), kvk.getTenKhuVuc(), kvk.getDiaChi()};
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        lblTable.setText("THÔNG TIN KHO");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        Dialog dialog = new CreateWarehouseDialog(null, true, this);
        dialog.setLocationRelativeTo(null);
        dialog.setResizable(false);
        dialog.setVisible(true);
